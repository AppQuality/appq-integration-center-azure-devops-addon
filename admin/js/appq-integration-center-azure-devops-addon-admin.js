(function($) {
	...
	$(document).ready(function() {
		...
		$('#azure_devops_settings .add_field_mapping').click(function(){
			...
			var proto = $('<div style="display:flex"><input type="text" placeholder="key" name="key"><textarea style="flex-grow:1" placeholder="value" name="value"></textarea><button class="btn btn-primary">OK</button></div>')
