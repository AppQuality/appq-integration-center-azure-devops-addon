...
<div class="row prevent-cols-breaking">
    ...
    <div class="col-sm-6 col-lg-3 col-xl-3 align-items-center justify-content-center text-center">
        <h6 class="text-primary"><?= __('Endpoint', 'appq-integration-center-azure-devops-addon') ?></h6>
    ...
    <div class="col-sm-6 col-md-3 col-lg-2 align-items-center justify-content-center">
        <h6 class="text-primary"><?= __('Media upload', 'appq-integration-center-azure-devops-addon') ?></h6>
        <?php
        $madiaUploadText = isset($campaign->bugtracker->upload_media) && $campaign->bugtracker->upload_media == 1 ? __('Yes', 'appq-integration-center-azure-devops-addon') : __('No', 'appq-integration-center-azure-devops-addon');
        ?>
        <span class="text-info"><?= $madiaUploadText ?></span>
    </div>
    <div class="col-sm-6 col-md-3 col-lg-4 col-xl-3 align-items-center justify-content-center">
        <?php
